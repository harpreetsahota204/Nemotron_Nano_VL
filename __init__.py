...
from .zoo import OPERATIONS, NemotronNanoModel
...
def load_model(model_name, model_path, **kwargs):
    ...
    return NemotronNanoModel(model_path=model_path, **kwargs)
...
def resolve_input(model_name, ctx):
    ...
    inputs.enum(
        ...
        required=True,
        label="Operation",
        description="Type of task to perform with NemotronNanoModel model",
